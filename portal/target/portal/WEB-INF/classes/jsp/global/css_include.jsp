...
<link href="css/introjs.css?<%=GlobalProperties.getAppVersion()%>" type="text/css" rel="stylesheet" />

<%-- <link href="css/introjs.min.css?<%=GlobalProperties.getAppVersion()%>" type="text/css" rel="stylesheet" /> --%>
<%-- <link href="css/introjs-rtl.css?<%=GlobalProperties.getAppVersion()%>" type="text/css" rel="stylesheet" />
<link href="css/introjs-rtl.min.css?<%=GlobalProperties.getAppVersion()%>" type="text/css" rel="stylesheet" /> --%>
