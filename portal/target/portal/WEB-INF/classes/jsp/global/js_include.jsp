...
<script type="text/javascript" src="js/lib/intro.js?<%=GlobalProperties.getAppVersion()%>"></script>
<%-- <script type="text/javascript" src="js/lib/intro.min.js?<%=GlobalProperties.getAppVersion()%"></script> --%>
