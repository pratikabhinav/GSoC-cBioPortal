...
%>
<div class="query_step_section" id="select_cancer_type_section" data-step="1" data-intro="Hey. Please <strong>select a cancer study</strong>. <br><br><i>This is a demo instance of cBioPortal with just one test study</i>" data-position="right">
